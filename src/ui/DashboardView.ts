          ...
          <aside class="donezo-sidebar">
            <div class="flex flex-col gap-6">
              ...
              <div class="flex items-center gap-2.5">
                <div class="w-8 h-8 rounded-full border-[2.5px] border-emerald-600 flex items-center justify-center">
              ...
              <div class="flex flex-col gap-6">
                <!-- MENU -->
                <div>
                  <div class="text-[11px] font-bold text-slate-400 tracking-wider uppercase mb-2 px-1">Menu</div>
                ...
                <!-- GENERAL -->
                <div>
                  <div class="text-[11px] font-bold text-slate-400 tracking-wider uppercase mb-2 px-1">General</div>
                  <nav class="flex flex-col gap-1">
            ...
            <div class="wavy-time-card p-4 rounded-2xl mt-6 hidden md:flex flex-col justify-between gap-2.5 relative overflow-hidden">
              ...
              <div>
                ...
                <p class="text-[11px] text-emerald-200/80 mt-0.5">Get easy in another way</p>
              </div>
            ...
            <div class="donezo-content">
              ...
              <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                  ...
                  <p class="text-xs sm:text-sm text-slate-500 font-medium mt-0.5">Plan, prioritize, and accomplish your tasks with ease.</p>
                </div>
              ...
              <div class="donezo-bento-grid">
                ...
                <div class="donezo-left-column">
                  <!-- SUB-ROW 1: Project Analytics + Reminders -->
                  <div class="donezo-left-top-row">
                    ...
                    <div class="bento-card p-5" id="analytics-section">
                      ...
                      <div class="flex items-end justify-between h-36 pt-4 px-2">
                        ...
                        <div class="flex flex-col items-center gap-2 relative">
                          <div class="absolute -top-6 px-1.5 py-0.5 rounded-full bg-slate-900 text-white font-mono text-[9px] font-bold shadow-md">74%</div>
                    ...
                    <div class="bento-card p-5 flex flex-col justify-between gap-3">
                      <div>
                        ...
                        <h3 class="text-base font-extrabold text-slate-900 mt-2 leading-snug">Meeting with Arc Company</h3>
                        <p class="text-xs text-slate-400 mt-1 font-medium">Time : 02.00 pm - 04.00 pm</p>
                      </div>
                  ...
                  <!-- SUB-ROW 2: Team Collaboration + Project Progress -->
                  <div class="donezo-left-bottom-row" id="team-section">
                    ...
                    <div class="bento-card p-5">
                      <div class="flex items-center justify-between mb-3">
                        ...
                        <button class="text-xs font-bold text-slate-600 border border-slate-200 px-2.5 py-0.5 rounded-full hover:bg-slate-50 transition-colors">+ Add Member</button>
                      </div>
                      ...
                      <div class="space-y-3 text-xs">
                        ...
                        <div class="flex items-center justify-between gap-2">
                          <div class="flex items-center gap-2.5 min-w-0">
                            <div class="w-7 h-7 rounded-full bg-rose-100 flex items-center justify-center text-xs shrink-0">👩‍💼</div>
                            <div class="truncate">
                              <div class="font-bold text-slate-900 truncate">Alexandra Deff</div>
                              <div class="text-[10px] text-slate-400 truncate">Working on <span class="font-medium text-slate-600">Github Project Repository</span></div>
                            </div>
                          </div>
                          <span class="text-[10px] font-bold px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200/60 shrink-0">Completed</span>
                        </div>

                        <!-- Member 2 -->
                        <div class="flex items-center justify-between gap-2">
                          <div class="flex items-center gap-2.5 min-w-0">
                            <div class="w-7 h-7 rounded-full bg-emerald-100 flex items-center justify-center text-xs shrink-0">👨‍💻</div>
                            <div class="truncate">
                              <div class="font-bold text-slate-900 truncate">Edwin Adenike</div>
                              <div class="text-[10px] text-slate-400 truncate">Working on <span class="font-medium text-slate-600">Integrate User Authentication System</span></div>
                            </div>
                          </div>
                          <span class="text-[10px] font-bold px-2 py-0.5 rounded-full bg-amber-50 text-amber-700 border border-amber-200/60 shrink-0">In Progress</span>
                        </div>

                        <!-- Member 3 -->
                        <div class="flex items-center justify-between gap-2">
                          <div class="flex items-center gap-2.5 min-w-0">
                            <div class="w-7 h-7 rounded-full bg-blue-100 flex items-center justify-center text-xs shrink-0">🧑‍🎨</div>
                            <div class="truncate">
                              <div class="font-bold text-slate-900 truncate">Isaac Oluwatemilorun</div>
                              <div class="text-[10px] text-slate-400 truncate">Working on <span class="font-medium text-slate-600">Develop Search and Filter Functionality</span></div>
                            </div>
                          </div>
                          <span class="text-[10px] font-bold px-2 py-0.5 rounded-full bg-rose-50 text-rose-700 border border-rose-200/60 shrink-0">Pending</span>
                        </div>

                        <!-- Member 4 -->
                        <div class="flex items-center justify-between gap-2">
                          <div class="flex items-center gap-2.5 min-w-0">
                            <div class="w-7 h-7 rounded-full bg-amber-100 flex items-center justify-center text-xs shrink-0">👨‍🚀</div>
                            <div class="truncate">
                              <div class="font-bold text-slate-900 truncate">David Oshodi</div>
                              <div class="text-[10px] text-slate-400 truncate">Working on <span class="font-medium text-slate-600">Responsive Layout for Homepage</span></div>
                            </div>
                          </div>
                          <span class="text-[10px] font-bold px-2 py-0.5 rounded-full bg-amber-50 text-amber-700 border border-amber-200/60 shrink-0">In Progress</span>
                        </div>
                    ...
                    <div class="bento-card p-5 flex flex-col justify-between">
                      ...
                      <div class="flex flex-col items-center justify-center my-auto py-1">
                        ...
                        <div class="text-center -mt-8">
                          ...
                          <div class="text-[11px] text-slate-400 font-medium mt-1">Project Ended</div>
                        </div>
                      </div>

                      <!-- Legend -->
                      <div class="flex items-center justify-center gap-3 pt-2 border-t border-slate-100 text-[10px] text-slate-600 font-medium">
                        <span class="flex items-center gap-1.5"><span class="w-2.5 h-2.5 rounded-full bg-[#114232]"></span> Completed</span>
                        <span class="flex items-center gap-1.5"><span class="w-2.5 h-2.5 rounded-full bg-[#52b788]"></span> In Progress</span>
                ...
                <!-- RIGHT COLUMN (Project Tasks + Time Tracker) -->
                <div class="donezo-right-column">
                  <!-- Project Tasks List -->
                  <div class="bento-card p-5" id="projects-section">
                    <div class="flex items-center justify-between mb-3">
